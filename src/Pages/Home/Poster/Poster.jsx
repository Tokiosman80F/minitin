...
const Poster = () => {
  return (
    <div className="relative">
      ...
      <div className="absolute bg-black/40 top-0 w-full h-full  text-white  p-20 ">
        ...
        <button className="border-2 font-medium border-white rounded-3xl px-5 py-1 hover:bg-white hover:text-blue-500">Start Shopping</button>
      </div>
    </div>
  );
};
